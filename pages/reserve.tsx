            ...
            <main className="text-white pt-16 md:pt-28">
                <div className="p-5" id="access">
                    ...
                    <div className="px-5 pt-5 md:px-16 md:pb-5">
                        ...
                        <div className="mt-5 md:mb-5">
                            <button className="text-green-500 btn group flex items-center bg-transparent p-2 px-6 text-xl font-thin">
                                <Link href="https://www.google.co.jp/maps" scroll={false} target="_blank" rel="noopener noreferrer" className="font-bold flex relative pr-4 pb-1 after:transition-transform after:duration-500 after:ease-out after:absolute after:bottom-0 after:left-0 after:block after:h-[2px] after:w-full after:origin-bottom-right after:scale-x-0 after:bg-white after:content-[''] after:group-hover:origin-bottom-left after:group-hover:scale-x-100">
                ...
                <div className="p-5" id="reserve">
                    ...
                    <div className="px-5 md:px-16">
                        ...
                        <button className="btn group flex items-center bg-transparent p-2 px-6 text-xl font-thin">
                            <Link href="https://beauty.hotpepper.jp/" scroll={false} target="_blank" rel="noopener noreferrer" className="font-bold md:font-normal flex relative pr-4 pb-1 after:transition-transform after:duration-500 after:ease-out after:absolute after:bottom-0 after:left-0 after:block after:h-[2px] after:w-full after:origin-bottom-right after:scale-x-0 after:bg-white after:content-[''] after:group-hover:origin-bottom-left after:group-hover:scale-x-100">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4">
